...
class ComUpdateStuForm extends Component {

    render() {
        const { visible, onCancel, onCreate, form, title } = this.props;
        const { getFieldDecorator } = form;
        const maskStyle = {
            backgroundColor: 'rgba(0,0,0,.085)',
            // animation: 'none'
        }
...
const WrappedUpdateComModal = Form.create({ name: 'form_in_modal2' })(ComUpdateStuForm);

export default WrappedUpdateComModal;