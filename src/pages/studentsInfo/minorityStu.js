...
import { getMinorityStudentInfo } from '../../actions/actionCreators'
...
class MinorityStudent extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount(){
        ...
        const action = getMinorityStudentInfo(params)
    ...
    render() {
        ...
        return (
            <div>
                <Table columns={columns} dataSource={this.props.studenMinoritytInfo} scroll={{ x: 1800 }}
...
export default connect(stateToProps, dispatchToProps)(MinorityStudent);